fn main()
{
    println!("Part 1: {}", number_of_ons(raw_input(), true));
    println!("Part 2: {}", number_of_ons(raw_input(), false));
}

fn number_of_ons(input: &'static str, test: bool) -> i64
{
...
fn count_zones(zones: &Vec<Cuboid>) -> i64
{
    let mut sum = 0;
    for zone in zones {
...
fn cut_cuboid(cuboid: Cuboid, axe: Axe, value: i64) -> (Cuboid, Option<Cuboid>, Option<Cuboid>)
{
...
fn parse_range(expected_axe: &'static str, string: &'static str) -> (i64, i64)
{
...
fn it_works()
{
    ...
    assert_eq!(590784, number_of_ons(test_input(), true));
    assert_eq!(2758514936282235, number_of_ons(test_input_2(), false));
}
